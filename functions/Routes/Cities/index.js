const { app, logger, db, admin } = require("../../setup");
...
// get list of cities
app.get("/api/cities/getAll", async (req, res) => {
...
app.post("/api/cities/add/:city", async (req, res) => {
...
app.get("/api/cities/getAllSorted", async (req, res) => {
  try {
